...
public class Log {
     ...
     */
    protected static int logLevel = WARN;
     ...
     * naspers_log_level: string representations of logging level (e.g. "debug", "info", ...)
     *
     * @param context The application context.
     */
    public static void configFromContext(Context context) {

        String levelStr = context.getResources().getString(R.string.log_level);

        android.util.Log.d(context.getPackageName(), "Loaded log level from resources: " + levelStr);
        ...
        switch (levelStr) {
            ...
            case "suppress":
                ...
                break;
            default:
                android.util.Log.e(TAG, "Incorrect level: " + levelStr);
        }
    }
     ...
     * D/Playground_MainActivity(  501): This is a debug message
     * <p>
